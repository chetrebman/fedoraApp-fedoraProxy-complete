...
public class FedoraProxyServletContextListener implements ServletContextListener, FedoraProxyServletContextListener_INF {
    ...
    public FedoraProxyServletContextListener()
    {
    	FedoraProxyConstants.setContextListener( this );
    }
	...
	public URL getFedoraProxyPropertiesURL() throws RuntimeException{
		
		URL resourceURL;
	    try
	    {
	        resourceURL = new URL( "file:"+getAppRealPath()+CONFIG_RELATIVE_URI_PATH+FedoraProxyConstants.PROPERTIES_FILE_NAME );
	    } 
	    catch (Exception e) 
	    {
	      throw new RuntimeException( e.getMessage() );
	...
	public String getAppRealPath() {
		...
		if ( FedoraProxyServletContextListener.webContextTestPath == null ) 
		{
			realPath = myServletContext.getRealPath("/");
		}
		else {
			realPath = FedoraProxyServletContextListener.webContextTestPath; 
		}
	...
	public void setContextTestPath( String contextTestPath ) {
		...
		FedoraProxyServletContextListener.webContextTestPath = contextTestPath;
	}
	...
	private  WebApplicationContext getWebAppContext() {
	    ...
	    wac = WebApplicationContextUtils.getRequiredWebApplicationContext( FedoraProxyServletContextListener.myServletContext );
		
		return null;	
	}

	public URL getFedoraProxyProgramPropertiesURL() throws RuntimeException 
	{
		URL resourceURL;
	    try
	    {
