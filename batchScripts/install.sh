...
then
   echo
   echo "*********************************************************************************************************************************************************"
   echo "Creating a batch directory tree ../batch_space/$fedoraNamespace to match the  fedora namespace this is also refered to as the 'institution' for a "
   echo "   multi-instituion repository and will appear in the GUI dropdown menu."
   echo "*********************************************************************************************************************************************************"
